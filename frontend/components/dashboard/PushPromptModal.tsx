...
export function PushPromptModal() {
  ...
  const shouldShow = visible && supported && !((permission === "granted" || subscribed) && status !== "success")
      ...
      {shouldShow && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-sm rounded-2xl bg-white border border-border shadow-2xl p-5"
          >
