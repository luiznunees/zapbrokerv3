...
const PLANS = [
    {
        ...
        name: "Starter",
        price: "39",
        features: ["5 disparos por mês", "500 leads", "2 conexões WhatsApp", "Suporte prioritário"],
        featured: false,
    },
    {
        id: "pro",
        name: "Pro",
        price: "79",
        features: ["Disparos ilimitados", "Leads ilimitados", "5 conexões WhatsApp", "Suporte VIP"],
        featured: true,
    },
]
            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center max-w-lg mx-auto mb-10">
                    ...
                    <h2 className="font-display text-2xl md:text-4xl font-bold tracking-tight mb-2 text-landing-navy text-balance">
                        Menos que um lead perdido por mês
                    </h2>
                    <p className="text-sm text-landing-navy/60">
                        Fale com a gente no WhatsApp pra ativar — sem formulário, sem cadastro complicado.
                    </p>
                </div>
