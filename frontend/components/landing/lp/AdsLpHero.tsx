...
import { ArrowUpRight, Clock, Smartphone, CreditCard } from "lucide-react"
import { WhatsAppMockup } from "@/components/landing/WhatsAppMockup"
import { WHATSAPP_CTA_URL } from "./constants"

export function AdsLpHero() {
    return (
        <section className="relative overflow-hidden landing-sky-gradient pt-10 pb-12 md:pt-16">
            <div className="container relative mx-auto px-4 md:px-6 text-center">
                ...
                <h1 className="font-display text-4xl md:text-6xl font-bold tracking-tight mb-5 text-white leading-[1.05] text-balance max-w-3xl mx-auto">
                    Ainda na dúvida sobre testar? Vamos direto ao ponto.
                </h1>

                <p className="text-base md:text-lg text-white/70 mb-8 leading-relaxed max-w-xl mx-auto">
                    O ZapBroker dispara sua campanha pra toda a carteira de uma vez, direto no seu WhatsApp — sem trocar de chip e sem perder nenhuma conversa.
                </p>
