            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="relative rounded-3xl landing-sky-gradient p-8 md:p-10 overflow-hidden">
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                        <div>
                            <h2 className="font-display text-2xl md:text-3xl font-bold text-white leading-tight max-w-md text-balance">
                                Bora ver na prática?
                            </h2>
                            <p className="text-sm text-white/70 mt-2 max-w-md">
                                Fala com a gente no WhatsApp e ativa em 2 minutos. Primeiro disparo é grátis.
                            </p>
                        </div>
