            ...
            <div className="flex gap-3 h-full">
                ...
                <div className="flex-1 rounded-lg bg-zinc-800/50 border border-white/5 p-2 flex flex-col gap-2">
                    ...
                    <div className="bg-zinc-800 border border-white/5 p-2 rounded shadow-sm opacity-60">
                        <div className="w-8 h-1 bg-primary/20 rounded-full mb-2" />
                ...
                <div className="flex-1 rounded-lg bg-zinc-800/50 border border-white/5 p-2 flex flex-col gap-2">
                    <div className="flex items-center justify-between mb-1">
                        <span className="text-[10px] text-landing-sky-light font-medium">Qualificados</span>
                        <span className="text-[8px] bg-primary/10 text-landing-sky-light px-1 py-0.5 rounded">2</span>
                    </div>
                    {/* Card Active */}
                    <div className="bg-zinc-800 border-l-2 border-l-primary border-y border-r border-white/10 p-2 rounded shadow-lg relative">
