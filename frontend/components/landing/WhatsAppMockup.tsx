        ...
        <div className="w-full max-w-sm rounded-3xl border border-border bg-card shadow-2xl shadow-black/5 overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-4 py-3 bg-brand-green-600 text-white">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-[11px] text-white/70 leading-tight">agente no seu WhatsApp</p>
                </div>
            </div>
            ...
            >
                ...
                <div className="flex justify-start">
                    <div className="max-w-[85%] bg-white rounded-lg rounded-tl-none px-3 py-2 shadow-sm">
                        <p className="text-[13px] text-zinc-800 leading-snug">
                            💡 João não respondeu há 3 dias. Quer que eu envie um lembrete?
                        </p>
                        <div className="flex gap-2 mt-2">
                            <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-brand-green-500 text-white">Aprovar</span>
                            <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-zinc-100 text-zinc-500">Recusar</span>
                        </div>
